...
export default {
	router: {
		...
		carComplaint: '汽车投诉',
		dataCentre: '数据中心',
		dictionaryManaged: '字典管理',
		cityManagement: '城市管理',
		brand: '品牌',
		automobileGroup: '汽车集团',
		carSeries: '车系',
		carModel: '车型',
		configurationManagement: '配置管理',
		notificationAnnouncement: '通知公告',
		FriendsChainManagement: '友链管理',
		personalData: '个人资料',
		articleManagement: '文章管理',
		programManagement: '栏目管理',
		siteSetting: '网站设置',
		systemTools: '系统工具',
		codeGeneration: '代码生成',
		presentationCase: '案例演示',
		casePresentation: '演示案例',
		casePresentation1: '演示案例一',
		casePresentation2: '演示案例二',
